...
function App() {
  ...
  useEffect(() => {
    ...
    if (!localStorage.getItem('works') && allWorks.length === 0) {
      localStorage.setItem('works', JSON.stringify([
        { id: 1, number: 1, work: "Learn React" },
        { id: 2, number: 2, work: "Deploy to Vercel" }
      ]));
    }
    fetchData();
  }, []);
  ...
  const handleEdit = async (id, updatedWork) => {
    ...
    setError(null);
    try {
      await API.updateWork(id, { work: updatedWork });
      fetchData();
      setEditingId(null);
    } catch (error) {
          ...
          <div className="card shadow mb-4">
            ...
            <div className="card-body">
              ...
              <div className="d-flex justify-content-between mb-3">
                <h3 className="h5 text-muted border-bottom pb-2">
                  Your Tasks
                </h3>
                <div>
                  <button 
